...
from src.Modules.Reportes.Infrastructure.Api import reporte_router
...
app.add_middleware(
	CORSMiddleware,
	allow_origins=[
        "https://ifnfrontend-mpm83c2ip-brayan-lizcanos-projects.vercel.app",
        "https://ifnfrontend.vercel.app"
    ],
